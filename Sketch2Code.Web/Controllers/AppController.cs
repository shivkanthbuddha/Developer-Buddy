...
namespace Sketch2Code.Web.Controllers
{
    ...
    public class AppController : BaseController
    {
        ...
        public async Task<ActionResult> Step2FromSample()
        {
            ...
            string[] folderFileName = Request.Url.Segments[Request.Url.Segments.Length - 1].Split('-');

            string Url =  Request.Url.Scheme + "://" + Request.Url.Authority + "/Content/email-attachments/" + folderFileName[0] + "/" +  folderFileName[1].Replace('_', '.');
